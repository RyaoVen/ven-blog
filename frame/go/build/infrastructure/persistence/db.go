...
//go:embed migrations/003_comments_reply_to.sql
var migration003 string

//go:embed migrations/004_guestbook.sql
var migration004 string

//go:embed migrations/005_settings.sql
var migration005 string

//go:embed migrations/006_post_category.sql
...
//go:embed migrations/009_ugc_status.sql
var migration009 string

//go:embed migrations/010_ai_reviewed.sql
var migration010 string

//go:embed migrations/011_visits.sql
var migration011 string

//go:embed migrations/012_pinned.sql
var migration012 string

// migrations 按序执行的迁移脚本（文件名即顺序）。
var migrations = []string{migration001, migration002, migration003, migration004, migration005, migration006, migration007, migration008, migration009, migration010, migration011, migration012}
