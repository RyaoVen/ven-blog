...
// 注：008 由并行单元（密钥管理）提供，合入时保持 008 在前 009 在后（数字序）。
var migrations = []string{migration001, migration002, migration003, migration004, migration005, migration006, migration007, migration009}
